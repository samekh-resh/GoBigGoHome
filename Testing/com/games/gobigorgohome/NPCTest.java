...
//    we'll need to do testing on the exceptions, for either exception
    ...
    public void setUp() throws IOException, ParseException {
        maintenanceGirl = new NPC("maintenance guy");
...
//one test for true when the name is right and one test for false
    ...
    public void getNPCLocation_shouldReturnStringLocation_whenCalled() {
        assertEquals(maintenanceGirl.getNpcLocation(), "front desk");
    }

    @Test
    public void getNPCLocation_shouldFailWhen_IfLocationIsNotThere() {
        assertNotEquals(maintenanceGirl.getNpcLocation(), "yoga studio");
    }
    @Test
